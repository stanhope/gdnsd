...
*/
void statsd_prepare(statsd_link *link, const char *stat, size_t value, const char *type, float sample_rate, char *buf, size_t buflen, int lf);
...
void statsd_prepare(statsd_link *link, const char *stat, size_t value, const char *type, float sample_rate V_UNUSED, char *message, size_t buflen, int lf)
{
